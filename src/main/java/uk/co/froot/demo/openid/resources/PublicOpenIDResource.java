...
public class PublicOpenIDResource extends BaseResource {
   ...
   */
    public PublicOpenIDResource() {
        ...
        if (OpenIDDemoService.getConfig().getProxyHost() != null) {
            ProxyProperties proxyProps = new ProxyProperties();
            proxyProps.setProxyHostName(OpenIDDemoService.getConfig().getProxyHost());
            proxyProps.setProxyPort(OpenIDDemoService.getConfig().getProxyPort());
  ...
  public Response authenticationRequest(
    ...
    } catch (YadisException e1) {
      log.error("YaDiscoveryException:", e1);
